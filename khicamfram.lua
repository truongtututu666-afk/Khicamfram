...
Info=Window:AddTab({ Title="Tab Info" }),
    Main=Window:AddTab({ Title="Tab này để fram" }),

Main1=Window:AddTab({ Title="Tab Fram Other" }),
    Sea=Window:AddTab({ Title="Tab fram sự kiện biển" }),
    ...
    Fruit=Window:AddTab({ Title="Tab tộc" }),
...
Button.Image = "rbxassetid://132815391220143"
